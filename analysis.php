						...
						<div class="col-md-8">
							...
							<article>
								...
								<div class="mark mb1">
									...
									<span class="ml1"><i class="fa fa-user-o"></i> Mathilde Lemoine</span>
								</div>
								...
								<p>&nbsp;</p>
								<p>Duis aute irure lor in reprehenderit in voluptate velit esse cillum eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>

								<blockquote class="with-image">
									<img src="http://placehold.it/140x160" alt="">
									<div class="q"><i class="fa fa-quote-right"></i></div>
									<p>La localisation des chambres de compensation en zone euro permettrait à la BCE d’avoir une meilleure connaissance des systèmes de paiement en euros.</p>
								</blockquote>
								...
								<p>Duis aute irure lor in reprehenderit in voluptate velit esse cillum eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
								<p>&nbsp;</p>
								<p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Duis aute irure dolor in.</p>
								...
								<h4>Franc to Ethereum - CHF/ETH</h4>
								<div class="chart" data-href=""></div>
								...
								<p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Duis aute irure dolor in.</p>
